...
class Player {
  ...
  Player(this.world) {
    ...
    suggestion_orb_loc = Location(world.map.width / 15.0, world.map.height / 4.8);
...
//          false);
//      ctx.fill();
    ctx.drawImageScaled(orb_image, (absolute_orb_pos.x + (2*ind + 0.2) * absolute_orb_radius).round(),
          (absolute_orb_pos.y + 0.5 * absolute_orb_radius).round(), (absolute_orb_radius * 1.6).round(), (absolute_orb_radius * 1.6).round());
    }
